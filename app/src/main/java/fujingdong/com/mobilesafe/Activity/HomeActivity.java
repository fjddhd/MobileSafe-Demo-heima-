...
public class HomeActivity extends Activity{
    ...
    private void showPasswordDialog() {
        //判断是否设置过密码
        //有的话，弹出设置密码框
        mpassword = PrefUtils.getString(HomeActivity.this, "password", null);
    ...
    private void showPasswordInputDialog() {
        ...
        inputdialog.setView(view, 0, 0, 0, 0);//设置边距为0，保证在2.X版本运行没问题

        final EditText et_input_password= (EditText) view.findViewById(R.id.et_password);
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String s = null;
                try {
                    s = MD5Encoder.encode(et_input_password.getText().toString());
                } catch (Exception e) {
                    e.printStackTrace();
                }
                if (TextUtils.isEmpty(s)){
                    Toast.makeText(HomeActivity.this,"输入框不能为空",Toast.LENGTH_SHORT).show();
                }else if (s.equals(mpassword)){
                    ...
                    Toast.makeText(HomeActivity.this,"密码错误，登录失败！",Toast.LENGTH_SHORT).show();
                }
            }
        });
        inputdialog.show();
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(password) && !TextUtils.isEmpty(confirm)){
                    if (password.equals(confirm)){
                        ...
                        try {
                            PrefUtils.setString(HomeActivity.this,"password",MD5Encoder.encode(password));//将密码以MD5的形式保存起来
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
